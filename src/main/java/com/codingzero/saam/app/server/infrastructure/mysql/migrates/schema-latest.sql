...
--
-- Host: localhost    Database: saam_v2
-- ------------------------------------------------------
...
CREATE TABLE `identifier_policies` (
  ...
  `is_verification_required` bit(1) NOT NULL DEFAULT b'0',
...
CREATE TABLE `identifiers` (
  `application_id` binary(16) NOT NULL,
  `identifier_type` varchar(25) NOT NULL,
  ...
  `creation_time` datetime(6) NOT NULL,
  `update_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`application_id`,`content_hash`),
  KEY `identifier_type_INDEX` (`application_id`,`identifier_type`),
...
--
-- Table structure for table `oauth_identifier_policies`
--

DROP TABLE IF EXISTS `oauth_identifier_policies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oauth_identifier_policies` (
  `application_id` binary(16) NOT NULL,
...
--
-- Table structure for table `oauth_identifiers`
--

DROP TABLE IF EXISTS `oauth_identifiers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oauth_identifiers` (
  `application_id` binary(16) NOT NULL,
  ...
  `creation_time` datetime(6) NOT NULL,
  `update_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`application_id`,`platform`,`content_hash`),
...
CREATE TABLE `permissions` (
  ...
  PRIMARY KEY (`application_id`,`resource_key_hash`,`principal_id`),
  KEY `creation_time_INDEX` (`creation_time`),
  KEY `principal_id_INDEX` (`application_id`,`principal_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-03-03 23:13:20
