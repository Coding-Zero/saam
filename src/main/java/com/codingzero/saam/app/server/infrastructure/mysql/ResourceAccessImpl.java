...
import com.codingzero.saam.app.server.infrastructure.mysql.commons.ResourceKeyHashUtil;
...
public class ResourceAccessImpl extends AbstractAccess implements ResourceAccess {
    ...
    public static final String TABLE = "saam_v2.resources";
    ...
    public boolean isDuplicateKey(String applicationId, String key) {
        String keyHash = ResourceKeyHashUtil.hash(key);
    ...
    public void insert(ResourceOS os) {
        String keyHash = ResourceKeyHashUtil.hash(os.getKey());
        String parentKeyHash = ResourceKeyHashUtil.hash(os.getParentKey());
        Connection conn = getConnection();
        PreparedStatement stmt = null;
        try {
    ...
    private List<ResourceOS> _selectByPrincipalId(ResultFetchRequest request) {
        ...
        String parentKeyHash = ResourceKeyHashUtil.hash(parentKey);
