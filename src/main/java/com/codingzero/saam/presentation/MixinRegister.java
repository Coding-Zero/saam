...
import com.codingzero.saam.presentation.mixin.CredentialRegisterRequestModel;
...
import com.codingzero.saam.presentation.mixin.OAuthIdentifierUpdateRequestModel;
import com.codingzero.saam.presentation.mixin.OAuthLoginRequestModel;
import com.codingzero.saam.presentation.mixin.OAuthRegisterRequestModel;
...
public class MixinRegister {
    ...
    public void register(ObjectMapper mapper) {
        ...
        mapper.addMixIn(CredentialRegisterRequest.class, CredentialRegisterRequestModel.class);
        mapper.addMixIn(OAuthRegisterRequest.class, OAuthRegisterRequestModel.class);
        mapper.addMixIn(IdentifierAssignRequest.class, IdentifierAssignRequestModel.class);
        ...
        mapper.addMixIn(OAuthIdentifierUpdateRequest.class, OAuthIdentifierUpdateRequestModel.class);
